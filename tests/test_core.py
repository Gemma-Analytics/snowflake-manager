from snowflake_manager.core import build_statements_list
...
def test_build_statements_list():
    ...
    test_statements = {
        "user": {
            "drop": ["USE ROLE admin; DROP USER user1", "USE ROLE admin; DROP USER user2"],
            "create": ["USE ROLE admin; CREATE USER user1", "USE ROLE admin; CREATE USER user2"],
